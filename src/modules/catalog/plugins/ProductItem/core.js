                        ...
                        >
                            <Show when={showWishlist && !usedInWishlist}>
                                <Button
                                    iconOnly
                                    icon={<HeartIcon />}
                                    iconProps={{ className: feed ? '!w-4 !h-4 text-neutral-white' : '!w-4 !h-4 group-hover:text-neutral-700' }}
                                    variant={feed ? 'primary' : 'outlined'}
                                    onClick={() => handleFeed(props)}
                                    className={classNames(
                                        'swift-action-towishlist !p-[10px] !border-neutral-50 !bg-neutral-50 hover:bg-primary group',
                            ...
                            <Show when={usedInWishlist}>
                                <Button
                                    iconOnly
                                    icon={<TrashIcon />}
                                    iconProps={{ className: '!w-4 !h-4 group-hover:text-neutral-700 text-primary' }}
                                    variant="outlined"
                                    onClick={() => handlingRemove()}
                                    className={classNames(
                                        'swift-action-toremove !p-[10px] !border-neutral-50 !bg-neutral-50 hover:bg-primary group',
                                        'hover:!shadow-none focus:!shadow-none hover:!opacity-100',
                                    )}
                                />
                            </Show>
                            <Show when={showProductCompare}>
                                <Button
                                    iconOnly
                                    icon={<CompareIcon />}
                                    iconProps={{ className: '!w-4 !h-4 group-hover:text-neutral-700' }}
                                    variant="outlined"
                                    onClick={() => handleSetCompareList(props?.id)}
                                    className={classNames(
                                        'swift-action-tocompare !p-[10px] !border-neutral-50 !bg-neutral-50 hover:bg-primary group',
                                        'hover:!shadow-none focus:!shadow-none hover:!opacity-100',
                                    )}
                                />
                            </Show>
    ...
    if (isGrid) {
        return (
            <>
                ...
                <div
                    className={classNames(
                        'group/action w-full inline-block h-full overflow-hidden relative cursor-pointer',
                ...
                >
                    ...
                    <div className="pt-4 relative text-center items-center flex flex-col gap-4 flex-1">
                        <DetailProductView
                            t={t}
                            urlKey={url_key}
